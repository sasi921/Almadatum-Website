...
<li class="nav-item"> <a class="nav-link" href="ss.php">Student status</a></li>
		  ...
		  <li class="nav-item">
			...
			<div class="collapse" id="ui-update">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="cm.php">Company</a>
...
echo "<h4><b> YEAR: ".$passed_out_year."</b></h4>";
                                    ...
                                    $query = "select c2.sno,c2.SID,c1.sname,c2.Btype from enterprenuer as c2,student_info as c1 where c1.SID=c2.SID and c1.passed_out_year='".$passed_out_year."'";
