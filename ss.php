...
echo "<h4><b> YEAR: ".$passed_out_year."</b></h4>";
                                    ...
                                    $query = "select c2.sno,c2.SID,c1.sname,c2.current_status from student_status as c2,student_info as c1 where c1.SID=c2.SID and c1.passed_out_year='".$passed_out_year."'";
...
$c=0;
						 ...
						 <form align="center"method="post" action="export3.php">
