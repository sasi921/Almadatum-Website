		...
		<div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header">
                        ...
                        </br><h4>HIGHER STUDIES</h4>
                    </div>
</br></br>
<h4>&emsp;Select Passed Out Year</h4>
...
echo "<h4><b> YEAR: ".$passed_out_year."</b></h4>";
                                    ...
                                    $query = "select c2.sno,c2.SID,c1.sname,c2.university,c2.continent,c2.proof from higher_studies as c2,student_info as c1 where c1.SID=c2.SID and c1.passed_out_year='".$passed_out_year."'";
						 ...
						 <form align="center"method="post" action="export1.php">
