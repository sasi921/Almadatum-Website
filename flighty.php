...
$Destination = '';
$query = "SELECT DISTINCT Destination FROM myflight order by Destination";
$statement = $connect->prepare($query);
$statement->execute();
$result = $statement->fetchAll();
foreach($result as $row)
{
 $Destination .= '<option value="'.$row['Destination'].'">'.$row['Destination'].'</option>';
}
...
{
$Destination = $_POST['filter_year'];
echo "<div align='center'><b><h4>".$Destination."</h4></b></div>";
}
$query ="SELECT * FROM company as c1,student_info as c2 where c1.SID=c2.SID AND c1.Destination='".$Destination."'";
