  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
	    <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="gm.php">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">GIVES</span>
            </a>
          </li>
            <li class="nav-item">
...
<html>
<head >
<meta name="viewport"align="center" content="">
<link align="center" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<style>
body {
	align:center
  font-family: Arial;
